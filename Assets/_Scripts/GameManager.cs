...
public class GameManager : MonoBehaviour
{
    ...
    public int globalFollowersLimit = 500;//as of 2018 Dec,im putting 500 people as limit,dear dev of future increase to 5000
...
//    void Update()
//    {
//        if ( (Input.GetKeyDown(KeyCode.Space) || Input.GetKeyDown(KeyCode.UpArrow)) && isGameStarted == false)
//        {
//            StartGame();
//        }
//    }
    ...
    public void StopGameByTimeOut()//called from GameTimer script
    {
		...
		FindObjectOfType<UIManager>().TimeOut ();
    ...
    private void FixedUpdate()
    {
        if (Time.timeSinceLevelLoad - lastTimeCheckAllDead > 1 && isGameEnded == false && isGameStarted)// using of two bool ? use gameState enum
        {
            ...
            sortedDataForUI = nonDeadList.OrderBy(o => o.GroupCount).ToList();//simple sort for ranking
    ...
    {
        List<GroupData> sortedList = data.OrderBy(o => o.GroupCount).ToList();
        sortedList.Reverse();
        return sortedList;
    }
