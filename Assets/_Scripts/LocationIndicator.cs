...
public class LocationIndicator : MonoBehaviour
{
    ...
    private bool OnScreen(Vector3 pos)
    {
        ...
        if (pos.x < (Screen.width) && pos.x > (Screen.width - Screen.width) &&
            pos.y < (Screen.height) && pos.y > (Screen.height - Screen.height) &&
    ...
    Vector3 WorldToScreen(Transform obj)
    {
        ...
        return Camera.main.WorldToScreenPoint(obj.position + new Vector3(0, 4, 0));
    }
