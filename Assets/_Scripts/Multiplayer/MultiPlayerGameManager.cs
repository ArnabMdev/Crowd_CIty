...
public class MultiPlayerGameManager : ColyseusManager<MultiPlayerGameManager>
{
    ...
    [SerializeField]
    private CrowdRoomController _roomController;
    ...
    public void Initialize(string roomName, Dictionary<string, object> roomOptions)
    {
        ...
        _roomController = new CrowdRoomController { roomName = roomName };
    ...
    public static void CreateNetworkedEntity(string prefab, Dictionary<string, object> attributes = null,
        ColyseusNetworkedEntityView viewToAssign = null, Action<NetworkedEntity> callback = null)
    {
